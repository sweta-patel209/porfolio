      ...
      <div className="container about-page">
        <div className="text-zone">
          ...
          <p>
            ...
            technologies on challenging and diverse projects not limited to javascript but all other key languages such as .NET, php, python and many more.
          </p>
          <p align="LEFT">
          ...
          <p>
            ...
            person, obedient daughter, keen interest in exploring different cultures,
